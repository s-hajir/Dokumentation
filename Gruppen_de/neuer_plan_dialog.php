    <dialog id="dialog">                                                                 <!--Dialog Bereich. Wird angezeigt bei Klick auf "+neuer plan" --> -->
      ...
      <form action="tagesplan.php" method="get">                                         <!--Bereich Neuer-Plan-Formular -->
        ...
        <?php include "freischalten_markieren_freunde.php" ?>                            <!-- Bereich: Freischalten für Freunde/Markieren von Freunden. Name des Dokumentes entspricht nicht buchstabengenu dem Namen der Gruppe--> 
